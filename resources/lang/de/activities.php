<?php
    return [
        ...
        'App\\Follow' => [
            ...
            'share' => 'hat eine Intensivkontrolle geteilt'
        ],
        'App\\Collection' => [
            'create' => 'hat eine Sammlung hochgeladen',
            'update' => 'hat eine Sammlung aktualisiert',
            'delete' => 'hat eine Sammlung gelöscht',
            'share' => 'hat eine Sammlung geteilt'
        ]
    ];